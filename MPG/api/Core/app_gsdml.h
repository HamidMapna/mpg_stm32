...
#define APP_GSDML_MOD_ID_Holding                       0x00000040
#define APP_GSDML_SUBMOD_ID_DIGITAL_DISCRETE_IN     0x00000130
#define APP_GSDML_SUBMOD_ID_DIGITAL_COILS_IN_OUT    0x00000132
#define APP_GSDML_SUBMOD_ID_INPUT_REGISTER          0x00000131
#define APP_GSDML_SUBMOD_ID_HOLDING_REGISTER        0x00000140

#define APP_GSDML_DISCRETE_INPUT_SIZE       3 /* 3*8=24 discrete inputs*/
#define APP_GSDML_COILS_INPUT_SIZE          13 /* 10*8=104 read coils */
#define APP_GSDML_COILS_OUTPUT_SIZE         3 /* 3*8=24 write coils */
#define APP_GSDML_HOLDING_INPUT_REGS_SIZE   100 /* 100 read hold regs*/
#define APP_GSDML_HOLDING_OUTPUT_REGS_SIZE  20 /* 20 write hold regs*/
#define APP_GSDML_INPUT_REGS_SIZE           24 /* 24 input regs*/
#define APP_GSDML_OUTPUT_MAX_SIZE           200 /*200 bytes maximum output data from controller*/	
