...
int app_utils_pnet_cfg_init_default(pnet_cfg_t* cfg)
{
    ...
    cfg->im_0_data.im_sw_revision_functional_enhancement = 0;// PNET_VERSION_MAJOR;
    cfg->im_0_data.im_sw_revision_bug_fix = 2;// PNET_VERSION_MINOR;
    cfg->im_0_data.im_sw_revision_internal_change = 0;// PNET_VERSION_PATCH;
