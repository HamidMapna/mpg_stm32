...
static const app_gsdml_module_t module_discrete_in = {
   .id = APP_GSDML_MOD_ID_8_0_DIGITAL_IN,
   .name = "Discrete Input 8xLogicLevel module",
   .submodules = {APP_GSDML_SUBMOD_ID_DIGITAL_DISCRETE_IN, 0},
};

static const app_gsdml_module_t module_input_register = {
   .id = APP_GSDML_MOD_ID_0_8_DIGITAL_OUT,
   .name = "Input Reg module",
   .submodules = {APP_GSDML_SUBMOD_ID_INPUT_REGISTER, 0}};

static const app_gsdml_module_t module_coils_in_out = {
   .id = APP_GSDML_MOD_ID_8_8_DIGITAL_IN_OUT,
   .name = "Coils 8xLogicLevel module",
   .submodules = {APP_GSDML_SUBMOD_ID_DIGITAL_COILS_IN_OUT, 0}};

static const app_gsdml_module_t module_holding_register = {
   .id = APP_GSDML_MOD_ID_Holding,
   .name = "Holding Reg module",
   .submodules = {APP_GSDML_SUBMOD_ID_HOLDING_REGISTER, 0}};
...
static const app_gsdml_submodule_t submod_digital_in = {
   .id = APP_GSDML_SUBMOD_ID_DIGITAL_DISCRETE_IN,
   .name = "Discrete Input",
   .api = APP_GSDML_API,
   .data_dir = PNET_DIR_INPUT,
   .insize = APP_GSDML_DISCRETE_INPUT_SIZE,
   .outsize = 0,
   .parameters = {0}};

static const app_gsdml_submodule_t submod_digital_out = {
   .id = APP_GSDML_SUBMOD_ID_INPUT_REGISTER,
   .name = "Input Register Submodule",
   .api = APP_GSDML_API,
   .data_dir = PNET_DIR_INPUT,
   .insize = APP_GSDML_INPUT_REGS_SIZE,
   .outsize = 0,
   .parameters = {0}};

static const app_gsdml_submodule_t submod_digital_inout = {
   .id = APP_GSDML_SUBMOD_ID_DIGITAL_COILS_IN_OUT,
   .name = "Coils Input/Output",
   .api = APP_GSDML_API,
   .data_dir = PNET_DIR_IO,
   .insize = APP_GSDML_COILS_INPUT_SIZE,
   .outsize = APP_GSDML_COILS_OUTPUT_SIZE,
   .parameters = {APP_GSDML_PARAMETER_1_IDX, APP_GSDML_PARAMETER_2_IDX, 0}};

static const app_gsdml_submodule_t submod_holding = {
   .id = APP_GSDML_SUBMOD_ID_HOLDING_REGISTER,
   .name = "Holding Register Submodule",
   .api = APP_GSDML_API,
   .data_dir = PNET_DIR_IO,
   .insize = APP_GSDML_HOLDING_INPUT_REGS_SIZE * 4,
   .outsize = APP_GSDML_HOLDING_OUTPUT_REGS_SIZE * 4,
...
static const app_gsdml_module_t * app_gsdml_modules[] = {
   &dap_1,
   &module_discrete_in,
   &module_input_register,
   &module_coils_in_out,
   &module_holding_register};
